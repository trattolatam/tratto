...
export const admin = {
  ...
  createCategory: (body: { name: string; emoji: string; phase: number; isHidden: boolean; priority?: boolean; force?: boolean }) =>
    apiFetch<{ category?: any; needsConfirmation?: boolean; similar?: any[] }>('/api/admin/categories', { method: 'POST', body: JSON.stringify(body) }),
